...
public class DateFormatUtils extends org.apache.commons.lang3.time.DateFormatUtils{
	public static Logger logger = LoggerFactory.getLogger(DateFormatUtils.class);
      /**
    ...
    public static String format(Date date) {
      ...
      **/
      public static Date parse(String aValue, Format aFormat){
              ...
              try{
	              if (aFormat instanceof FastDateFormat) {
	                      return (Date) ((FastDateFormat) aFormat).parseObject(aValue);
      ...
      public static Timestamp convertStrToTimestamp(String dateStr, String pattern) throws ParseException {
    	  return new Timestamp(parse(dateStr, FastDateFormat.getInstance(pattern)).getTime());
      }
