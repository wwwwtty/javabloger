...
<li>
<div class="post_date"><span class="date_y"><?php the_time('Y') ?></span><span class="date_m"><?php the_time('M') ?>月</span><span class="date_d"><?php the_time('d') ?></span></div>
<div class="article">
...
<div class="clear"></div>
<div class="info">作者：<?php the_author() ?> | 分类：<?php the_category(', ') ?> <?php if(function_exists(the_views)) { the_views(true,'| 阅读：',' 次');}?> | <?php the_tags('标签：', ', ', ''); ?></div><div class="comments_num"><?php comments_popup_link ('抢沙发','1条评论','%条评论'); ?></div>
