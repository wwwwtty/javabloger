...
public class Main
{
    ...
    **/
     ...
     */
    public static final String CONFIG_DIRECTORY = "felix-conf";
    ...
    **/
    public void loadSystemProperties()
    {
        ...
        else
        {
            ...
            System.out.println("getClass: " + ClassLoader.getSystemResource("").getFile());
            
                // Can't figure it out so use the current directory as default.
            File confDir = new File(ClassLoader.getSystemResource("").getFile(), CONFIG_DIRECTORY);
     ...
     * @throws IOException 
    **/
    public Map<String, String> loadConfigProperties() throws IOException
    {
...
//        	Resource resource=loader.getResource(CONFIG_DIRECTORY);
//        	 File confDir =resource.getFile();
        	 
        	 Launcher launcher=new sun.misc.Launcher();
        	 ClassLoader ld= launcher.getClassLoader();
        	 String confDir=ld.getResource(CONFIG_DIRECTORY).getFile();
        	 
        	 System.err.print("resource: " + confDir);
//            new File(ClassLoader.getSystemResource("").getFile(), CONFIG_DIRECTORY);
