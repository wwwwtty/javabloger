...
public class BundlePluginTest extends AbstractBundlePluginTest
{
    ...
    {
        Map<String,String> instructions = new TreeMap<String,String>();
    ...
    public void testPackageInfoDetection() throws Exception
    {
        ...
        assertEquals( "org/hsc/novelSpider/bundleplugin/packageinfo="
            + "src/test/java/org/hsc/novelSpider/bundleplugin/packageinfo", resourcePaths );
    }
